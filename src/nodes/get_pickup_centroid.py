...
def start_node():
    ...
    ts = message_filters.ApproximateTimeSynchronizer([object_class, object_poseStamped, object_is_bb_intersecting, object_pointcloud], queue_size=1, slop=1000000000000000000, allow_headerless=True)
